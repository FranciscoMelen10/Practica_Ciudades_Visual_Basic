...
Public NotInheritable Class Frm_Presentacion
    ...
    Private Sub SplashScreen1_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        '  propiedades del proyecto (bajo el menú "Proyecto").'Francisco De Jesus Melendez Simplina'
        ...
        '  Se pudo incluir la información Simplina de compilación y revisión usando el siguiente código y cambiando el 
